# TRUE LOSO v4 - Temporal LSTM (5-frame sequences)
# CNN extracts features per frame, LSTM captures temporal dynamics
...
IMG_SIZE = 96; BATCH_SIZE = 32; SEQ_LEN = 5; LSTM_UNITS = 64
STEPS = 60
